...
您的意思是修改一下源代码，然后对用户收费？哈哈，这就好像很多公司修改了linux的源代码，说自己是国产原创；很多人盗用bitcoin的源代码，说自己是自主研发。本软件是开源的，用户可以自由下载，目的是方便普通用户在本地电脑离线使用。但是我们并不提供开发文档，该软件源代码也不允许商业用途，如果你修改了此软件的源代码进行商用，我们保留法律诉讼的权利。
